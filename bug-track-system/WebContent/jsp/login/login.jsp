...
<div id="header">
    <div id="logo">
        <h1><span>Bug Track System</span></h1>
    </div>
            ...
            <form action="login" name="login" method="post" onSubmit="return loginValidation()">
                <table width="333" height="188" border="0" align="center">
                    ...
                    <tr>
                        ...
                        <td width="213">
                            <input name="username" type="text" value="chethan" />
                        </td>
                    </tr>
                    <tr>
                        <td>
    ...
    <div id="footer">
        <p class="copyright">&copy;&nbsp;&nbsp;2020 All Rights Reserved &nbsp;&bull;&nbsp; Design by Bug Track System team</a>.</p>
    </div>
</div>
</body>
</html>