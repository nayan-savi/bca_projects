...
<div id="wrapper">
    <div id="page">
        ...
        <form action="/updateEmpFlowerOrder?anchor=updateEmpFlowerOrder" name="updateFlowerOrder" method="post">
            ...
            <table>
                ...
                <tr>
                    <td>Assigned To</td>
                    <td><input readonly="true" type="text" name="assignedTo" value="<%=flowerOrder.getAssignedTo() %>"/></td>
                </tr>

                <tr>
                    <td>Final Rate</td>
                    <td><input readonly="true" type="text" name="finalRate" value="<%=flowerOrder.getFinalRate() %>"/></td>
                </tr>
                <tr>
                    <td>Status</td>
                    <td>
