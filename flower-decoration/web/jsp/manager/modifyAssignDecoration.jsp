        ...
        <form action="/updateDecorationOrder?anchor=updateDecorationOrder" name="updateDecorationOrder" method="post">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><input disabled type="text" name="flowerName" value="<%=decorationOrder.getDecorationName() %>"/></td>
                </tr>
                <tr>
                    <td>Decoration Cost</td>
                    <td><input disabled type="text" name="flowerCost" value="<%=decorationOrder.getDecorationCost() %>"/></td>
                </tr>
                <tr>
                    <td>Request Date</td>
                    <td><input disabled type="text" name="requestDate" value="<%=decorationOrder.getRequestDate() %>"/></td>
                </tr>
                <tr>
                    <td>Bargaining</td>
                    <td><input disabled type="text" name="bargaining" value="<%=decorationOrder.getBargaining() %>"/></td>
                </tr>
