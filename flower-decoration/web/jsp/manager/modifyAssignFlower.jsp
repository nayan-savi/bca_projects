    ...
    <div id="page">
        ...
        <form action="/updateFlowerOrder?anchor=updateFlowerOrder" name="updateFlowerOrder" method="post">
            ...
            <table>
                ...
                <tr>
                    <td>Flower Name</td>
                    <td><input disabled type="text" name="flowerName" value="<%=flowerOrder.getFlowerName() %>"/></td>
                </tr>
                <tr>
                    <td>Flower Cost</td>
                    <td><input disabled type="text" name="flowerCost" value="<%=flowerOrder.getFlowerCost() %>"/></td>
                </tr>
                <tr>
                    <td>Request Date</td>
                    <td><input disabled type="text" name="requestDate" value="<%=flowerOrder.getRequestDate() %>"/></td>
                </tr>
                <tr>
                    <td>Bargaining</td>
                    <td><input disabled type="text" name="bargaining" value="<%=flowerOrder.getBargaining() %>"/></td>
                </tr>
