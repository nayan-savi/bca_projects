...
<div id="wrapper">
    ...
    <div id="page">
        ...
        <form action="" name="addFlower" method="post">
            <h1>ADD FLOWER DETAILS</h1>
            <table>
                <tr><td>Flower Name</td><td><input type="text" name="flowerName"/></td></tr>
                <tr><td>Flower Cost</td><td><input type="text" name="flowerCost"/></td></tr>
                <tr>
                    <td>Status</td>
                    <td>
                        <select name="status">
