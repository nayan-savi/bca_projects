    ...
    <div id="page">
        ...
        <form action="" name="addEmployee" method="post">
            ...
            <table>
                ...
                <tr>
                    <td>DateOfJoin</td>
                    <td><input type="date" name="dateOfJoin" style="width: 172px;"/>(Ex:dd-mm-yyyy)</td>
                </tr>
                <tr>
                    <td>Qualification</td>
                ...
                <tr>
                    <td>Dob</td>
                    <td><input type="date" name="dob" style="width: 172px;"/>(Ex:dd-mm-yyyy)</td>
                </tr>
                ...
                <tr>
                    <td>RelievingDate</td>
                    <td><input type="date" name="relievingDate" style="width: 172px;"/>(Ex:dd-mm-yyyy)</td>
                </tr>
